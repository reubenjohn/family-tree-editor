...
<p align="center">
  <a href="#buildstatus">
    <img alt="build status" src="https://github.com/reubenjohn/family-tree/workflows/Build/badge.svg">
  </a>
  <a href="https://coveralls.io/github/reubenjohn/family-tree?branch=master">
    <img alt="coverage status" src="https://coveralls.io/repos/github/reubenjohn/family-tree/badge.svg?branch=master">
  </a>
...
<p align="center">
  <h3 align="center"><a href="https://reubenjohn.github.io/family-tree">👾 Playground</a></h3>
  <h3 align="center"><a href="https://reubenjohn.github.io/family-tree/docs">📖 API Documentation (v2)</a></h3>
</p>
...
> **Want to see what's changed in v2? Check out the [v2 release notes](https://github.com/reubenjohn/family-tree/releases/tag/v2.0.0).**

> **Looking for v1? Click [here](https://github.com/reubenjohn/family-tree/tree/v1).**
...
## Props
For details on all props accepted by  `Tree`, check out the [TreeProps reference docs](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html).

The only required prop is [data](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#data), all other props on `Tree` are optional/pre-defined (see "Default value" on each prop definition).
...
### Providing `data`
By default, `Tree` expects each node object in `data` to implement the [`RawNodeDatum` interface](https://reubenjohn.github.io/family-tree/docs/interfaces/_types_common_.rawnodedatum.html):
...
```
 ...
 > For more details on the `className` props for nodes, see the [TreeProps reference docs](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html).
...
> For more details, see the `PathClassFunction` [reference docs](https://reubenjohn.github.io/family-tree/docs/modules/_types_common_.html#pathclassfunction).

### Event Handlers
`Tree` exposes the following event handler callbacks by default:

- [onLinkClick](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#onlinkclick)
- [onLinkMouseOut](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#onlinkmouseout)
- [onLinkMouseOver](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#onlinkmouseover)
- [onNodeClick](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#onnodeclick)
- [onNodeMouseOut](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#onnodemouseout)
- [onNodeMouseOver](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#onnodemouseover)

> **Note:** Nodes are expanded/collapsed whenever `onNodeClick` fires. To prevent this, set the [`collapsible` prop](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#collapsible) to `false`.  
...
The [`renderCustomNodeElement` prop](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#rendercustomnodeelement) accepts a **custom render function that will be used for every node in the tree.**
...
### `pathFunc`
The [`pathFunc` prop](https://reubenjohn.github.io/family-tree/docs/interfaces/_tree_types_.treeprops.html#pathfunc) accepts a predefined `PathFunctionOption` enum or a user-defined `PathFunction`.
...
The currently [available enums](https://reubenjohn.github.io/family-tree/docs/modules/_types_common_.html#pathfunctionoption) are:
- `diagonal` (default)
- `elbow`
- `straight`
- `step`

> Want to see how each option looks? [Try them out on the playground](https://reubenjohn.github.io/family-tree).
...
> For more details, see the [`PathFunction` reference docs](https://reubenjohn.github.io/family-tree/docs/modules/_types_common_.html#pathfunction).
...
## Contributors
A huge thank you to all the [contributors](https://github.com/reubenjohn/family-tree/graphs/contributors), as well as users who have opened issues with thoughtful suggestions and feedback.
